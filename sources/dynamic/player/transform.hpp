...
namespace spacerisk
{
    ...
    {
        UGDCLASS(PlayerTransform, Transform)

    private:
        godot::CharacterBody3D *player = nullptr;
        godot::Marker3D *player_head = nullptr;

    protected:
        static void _bind_methods();

    public:
        IMPL_PROPERTY(godot::CharacterBody3D *, player)
        IMPL_PROPERTY(godot::Marker3D *, player_head)
